...
Une micro-influenceuse affiliée à une grande marque de cosmétique ne peut pas avoir la main sur ces clientes “ou affiliés” qui commandent via son lien.  
  
Elle souhaiterait pouvoir avoir un outil lui permettant d’avoir une vue globale de ces clientes afin de pouvoir les recontacter et les recontacter.

### Par où commencer ?

Cela est possible grâce à une entrée de donnée qui provient du mail de confirmation de commande de l’entreprise de cosmétique auquel la cliente est affilié.  
Voici les informations que l’on y voit dans le mail :
...
Pour obtenir toutes les informations, nous devons vérifier si client existe bien, s’il existe. Nous devons mapper correctement les données.  
...
C’est pour ça que le travail ne consiste pas forcément à avoir une base de données. Mais de pouvoir la transformer en données fiables et pertinentes pour accroitre la croissance.

###   
Connaitre son “Top 10 clientes” et “Top produit du mois”.
...
Un des gros point de douleurs a résoudre avec ce projet est la segmentation des abonnées et acheteuse des produits. 
...
Grâce à la date de commande, nous pouvons savoir quel cliente/abonnée a stoppé d'être active dans ses achats avec la micro-influenceuse. 

Une page est dedié pour ce cas d'usage ce qui permet aux équipes d'exporter la liste de cliente afin de les contacter ou relancer par email via Instagram grâce au nom et prénom. 
